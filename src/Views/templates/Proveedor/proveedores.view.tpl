...
<section class="container-m row px-4 py-4 gm-filter">
    <form action="index.php?page=Proveedores_Proveedores" method="GET" class="col-12 row align-center gm-filter-form">
    ...
    <table class="col-12 gm-table">
        <thead>
            <tr>
                ...
                <th>Email</th>
                <th>Estado</th>
                <th><a href="index.php?page=Proveedores_Proveedor&mode=INS" class="button gm-link-btn">+ Nuevo</a></th>
            </tr>
        </thead>
        <tbody>
            {{foreach proveedores}}
            <tr>
                ...
                <td class="gm-actions-cell">
                    <a class="gm-action" href="index.php?page=Proveedores_Proveedor&mode=UPD&provcod={{provcod}}">Editar</a>
                    <a class="gm-action gm-action-danger" href="index.php?page=Proveedores_Proveedor&mode=DEL&provcod={{provcod}}">Eliminar</a>
                </td>
            </tr>
            {{endfor proveedores}}
        </tbody>
...
@media(max-width:760px){.gm-logo-corner img{height:70px;width:70px;bottom:64px}.gm-header h1,.gm-filter-form,.gm-table{box-shadow:5px 5px 0 rgba(17,24,39,.24)}.gm-btn{width:100%}.gm-table-wrap{overflow-x:auto}.gm-table{min-width:760px}}
</style>
